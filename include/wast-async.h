...
namespace evm2wasm
{
  static std::map<opcodeEnum, WastCode> wastAsyncInterface =
  {
    {
  opcodeEnum::LOG, {
      "(func $LOG\n"
  ...
  opcodeEnum::BALANCE, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "    (i64.store (i32.add (get_global $sp) (i32.const 24)) (i64.const 0))\n"
      "    (i64.store (i32.add (get_global $sp) (i32.const 16)) (i64.const 0)))",
    "(import \"ethereum\" \"getBalance\" (func $getBalance (param i32 i32 i32) ))"
  }
},{
  opcodeEnum::ORIGIN, {
    ";; generated by ./wasm/generateInterface.js\n"
  ...
  opcodeEnum::CODESIZE, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "    (i64.store (i32.add (get_global $sp) (i32.const 48)) (i64.const 0))\n"
      "    (i64.store (i32.add (get_global $sp) (i32.const 40)) (i64.const 0)))",
    "(import \"ethereum\" \"getCodeSize\" (func $getCodeSize (param i32) (result i32)))"
  }
},{
  opcodeEnum::CODECOPY, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "          (i64.load (i32.add (get_global $sp) (i32.const -24)))\n"
      "          (i64.load (i32.add (get_global $sp) (i32.const -16)))\n"
      "          (i64.load (i32.add (get_global $sp) (i32.const -8))))(get_local $length0)(get_local $callback)))",
    "(import \"ethereum\" \"codeCopy\" (func $codeCopy (param i32 i32 i32 i32) ))"
  }
},{
  opcodeEnum::EXTCODESIZE, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "    (i64.store (i32.add (get_global $sp) (i32.const 16)) (i64.const 0))\n"
      "    (i64.store (i32.add (get_global $sp) (i32.const 8)) (i64.const 0)))",
    "(import \"ethereum\" \"getExternalCodeSize\" (func $getExternalCodeSize (param i32 i32) (result i32)))"
  }
},{
  opcodeEnum::EXTCODECOPY, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "          (i64.load (i32.add (get_global $sp) (i32.const -56)))\n"
      "          (i64.load (i32.add (get_global $sp) (i32.const -48)))\n"
      "          (i64.load (i32.add (get_global $sp) (i32.const -40))))(get_local $length0)(get_local $callback)))",
  ...
  opcodeEnum::GASPRICE, {
    ...
    "(import \"ethereum\" \"getTxGasPrice\" (func $getTxGasPrice (param i32) ))"
  }
},{
  opcodeEnum::BLOCKHASH, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "      )",
    "(import \"ethereum\" \"getBlockHash\" (func $getBlockHash (param i32 i32 i32) ))"
  }
},{
  opcodeEnum::COINBASE, {
    ";; generated by ./wasm/generateInterface.js\n"
  ...
  opcodeEnum::CREATE, {
    ...
    "(import \"ethereum\" \"create\" (func $create (param i32 i32 i32 i32 i32) ))"
  }
},{
  opcodeEnum::CALL, {
    ";; generated by ./wasm/generateInterface.js\n"
    ...
    "(import \"ethereum\" \"call\" (func $call (param i64 i32 i32 i32 i32 i32) (result i32)))"
  }
},{
  opcodeEnum::CALLCODE, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "    (i64.store (i32.add (get_global $sp) (i32.const -176)) (i64.const 0))\n"
      "    (i64.store (i32.add (get_global $sp) (i32.const -184)) (i64.const 0)))",
    "(import \"ethereum\" \"callCode\" (func $callCode (param i64 i32 i32 i32 i32 i32) (result i32)))"
  }
},{
  opcodeEnum::DELEGATECALL, {
    ";; generated by ./wasm/generateInterface.js\n"
      ...
      "    (i64.store (i32.add (get_global $sp) (i32.const -176)) (i64.const 0))\n"
      "    (i64.store (i32.add (get_global $sp) (i32.const -184)) (i64.const 0)))",
    "(import \"ethereum\" \"callDelegate\" (func $callDelegate (param i64 i32 i32 i32 i32 i32) (result i32)))"
  }
},{
  ...
  opcodeEnum::SSTORE, {
    ...
    "(import \"ethereum\" \"storageStore\" (func $storageStore (param i32 i32 i32) ))"
  }
},{
  opcodeEnum::SLOAD, {
    ";; generated by ./wasm/generateInterface.js\n"
  ...
  opcodeEnum::SELFDESTRUCT, {
    ";; generated by ./wasm/generateInterface.js\n"
        "(func $SELFDESTRUCT   (call $selfDestruct(get_global $sp)))",
